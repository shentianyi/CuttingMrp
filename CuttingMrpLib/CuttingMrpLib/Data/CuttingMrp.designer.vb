...
Partial Public Class ProcessOrder
	...
	Private _proceeDate As System.Nullable(Of Date)
    ...
    Partial Private Sub OnderivedFromChanged()
    End Sub
    Partial Private Sub OnproceeDateChanging(value As System.Nullable(Of Date))
    End Sub
	...
	<Global.System.Data.Linq.Mapping.ColumnAttribute(Storage:="_proceeDate", DbType:="DateTime")>  _
	Public Property proceeDate() As System.Nullable(Of Date)
		Get
			Return Me._proceeDate
		End Get
		Set
			If (Me._proceeDate.Equals(value) = false) Then
	...
	<Global.System.Data.Linq.Mapping.ColumnAttribute(Storage:="_createAt", DbType:="DateTime")>  _
	Public Property createAt() As System.Nullable(Of Date)
		Get
			Return Me._createAt
		End Get
		Set
			If (Me._createAt.Equals(value) = false) Then
				Me.OncreateAtChanging(value)
				Me.SendPropertyChanging
				Me._createAt = value
...
Partial Public Class ProcessOrderView
	...
	<Global.System.Data.Linq.Mapping.ColumnAttribute(Storage:="_Expr1", DbType:="VarChar(200) NOT NULL", CanBeNull:=false)>  _
